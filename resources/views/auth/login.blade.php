...
<head>
  <title>ECSECOND || Login Page</title>
              ...
              <div class="col-lg-6">
                <div class="p-5">
                  ...
                  <form class="user"  method="POST" action="{{ route('login') }}">
                    ...
                    <div class="form-group">
                      <label class="small text-gray-700 ml-2">Captcha: {{$captchaQuestion}} = ?</label>
                      <input type="number" class="form-control form-control-user @error('captcha_answer') is-invalid @enderror" name="captcha_answer" placeholder="Enter captcha answer" required>
