    ...
    <table class="table table-bordered table-stripe">
      ...
      @endphp
        <tr>
          ...
          <td><span>{{Helper::rupiah($cart->price)}}</span></td>
        </tr>
      @endforeach
      </tbody>
      <tfoot>
        <tr>
          ...
          <th scope="col"> <span>{{Helper::rupiah($order->sub_total)}}</span></th>
        </tr>
      ...
      @endif --}}
        <tr>
          <th scope="col" class="empty"></th>
          <th scope="col" class="text-right ">Shipping Cost:</th>
          <th><span>{{Helper::rupiah($order->resolved_shipping_cost)}}</span></th>
        </tr>
        <tr>
          <th scope="col" class="empty"></th>
          ...
          <th>
            <span>
                {{Helper::rupiah($order->total_amount)}}
            </span>
          </th>
        </tr>
      </tfoot>
