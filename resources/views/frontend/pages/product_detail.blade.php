...
@endsection
@section('title','ECSECOND || PRODUCT DETAIL')
										...
										<div class="product-des">
											...
											<div class="short">
												...
												<div class="rating-main">
													...
													<a href="#reviews" class="total-review">({{$product_detail['getReview']->count()}}) Review</a>
                                                </div>
                                                @php 
                                                    $after_discount=($product_detail->price-(($product_detail->price*$product_detail->discount)/100));
                                                @endphp
												<p class="price"><span class="discount">{{Helper::rupiah($after_discount)}}</span><s>{{Helper::rupiah($product_detail->price)}}</s> </p>
                                ...
                                <div class="single-product">
                                    ...
                                    <div class="product-content">
                                        ...
                                        <div class="product-price">
                                            ...
                                            @endphp
                                            <span class="old">{{Helper::rupiah($data->price)}}</span>
...
@endpush
	...
	<script>
		$(document).ready(function(){
			...
			$('.total-review').on('click', function(event){
